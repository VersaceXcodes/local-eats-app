...
export const createUserInputSchema = z.object({
    ...
    phone_number: z.preprocess((val) => {
        ...
        return val;
    }, z.string().regex(/^\+?[1-9]\d{1,14}$/).optional()).optional(),
...
export const updateUserInputSchema = z.object({
    ...
    phone_number: z.preprocess((val) => typeof val === 'string' ? val.replace(/[\s-]/g, '') : val, z.string().regex(/^\+?[1-9]\d{1,14}$/).optional()).optional(),
    profile_picture_url: z.string().url().nullable().optional(),
    notification_preferences: notificationPreferencesSchema.optional(),
    location_permission_granted: z.boolean().optional(),
    profile_public: z.boolean().optional(),
